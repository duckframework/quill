...
SYSTEMD_ENVIRONMENT: dict = {
    "DUCK_SETTINGS_MODULE": os.environ.get('DUCK_SETTINGS_MODULE', "web.settings")
}
...
# Streams pre-built HTML designs instantly so you can test
# the full UI flow (streaming, preview, resize, download)
# without needing Anthropic, Gemini, or Groq credentials.
# Set to False (or remove) when you have real API keys.
QUILL_DUMMY_MODE: bool = False
